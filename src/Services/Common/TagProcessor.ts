...
export default class TagProcessor {
    ...
    static processSutraNumberTag(t: string, r = !1) {
        return t.replace(/\[\[([०-९0-9])[-_.|॥।/]([०-९0-9])[-_.|॥।/]([०-९0-9]{1,3})\]\]/g, ((t: string | any[]) => {
            var e = t[2],
                a = t[4],
    ...
    static processSutraReferences(t: { replaceAll: (arg0: RegExp, arg1: (t: any, e: any) => string) => { (): any; new(): any; replaceAll: { (arg0: RegExp, arg1: (t: any, e: any) => string): { (): any; new(): any; replaceAll: { (arg0: RegExp, arg1: (t: any, e: any) => string): { (): any; new(): any; replaceAll: { (arg0: RegExp, arg1: (t: any, e: any) => string): any; new(): any; }; }; new(): any; }; }; new(): any; }; }; }) {
        return t.replaceAll(/<{SK([0123456789०१२३४५६७८९]+)}>/, (function(t: any, e: any) {
